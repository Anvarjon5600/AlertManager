...
} from "./chunk-7S4YOL5M.js";
import {
  createSvgIcon,
  isMuiElement_default,
  useId_default
} from "./chunk-TE3QN5Y4.js";
import {
  Typography_default
} from "./chunk-V2W3R2AD.js";
import {
  capitalize_default
} from "./chunk-T42G3VBV.js";
import {
  memoTheme_default
} from "./chunk-XJXT32FP.js";
import {
  InitColorSchemeScript_default,
  ThemeProvider,
  useColorScheme,
  useThemeProps
} from "./chunk-72B6PAL5.js";
import {
  useDefaultProps
} from "./chunk-T4HMRD5F.js";
import {
  createTheme,
  styled_default
} from "./chunk-GYN2PQ2S.js";
import {
  BrandingContext,
  NavigationContext,
  PaletteModeContext,
...
} from "./chunk-I5P4XXIC.js";
import {
  require_jsx_runtime
} from "./chunk-UXW64E2S.js";
import {
  require_react_dom
...
function useDropdown(parameters = {}) {
  ...
  const [popupId, setPopupId] = React29.useState("");
  const [triggerElement, setTriggerElement] = React29.useState(null);
  const lastActionType = React29.useRef(null);
  const handleStateChange = React29.useCallback((event, field, value, reason) => {
    if (field === "open") {
      onOpenChange == null ? void 0 : onOpenChange(event, value);
    }
    lastActionType.current = reason;
  }, [onOpenChange]);
  const controlledProps = React29.useMemo(() => openProp !== void 0 ? {
    open: openProp
  } : {}, [openProp]);
...
function FocusTrap(props) {
  ...
  return (0, import_jsx_runtime11.jsxs)(React31.Fragment, {
...
function useTextNavigation(callback) {
  ...
  return React37.useCallback((event) => {
...
function useList(params) {
  ...
  const handleHighlightChange = React38.useCallback((event, value, reason) => {
    var _a;
  ...
  const stateComparers = React38.useMemo(() => ({
    highlightedValue: itemComparer,
    selectedValues: (valuesArray1, valuesArray2) => areArraysEqual(valuesArray1, valuesArray2, itemComparer)
  }), [itemComparer]);
  const handleStateChange = React38.useCallback((event, field, value, reason, state2) => {
  ...
  const listActionContext = React38.useMemo(() => {
    return {
      disabledItemsFocusable,
      disableListWrap,
      focusManagement,
  ...
  const actionContext = React38.useMemo(() => ({
  ...
  const previousItems = React38.useRef([]);
  React38.useEffect(() => {
  ...
  const getItemState = React38.useCallback((item) => {
...
var ListContext = React39.createContext(null);
if (true) {
...
function useListItem(parameters) {
  ...
  const createHandleClick = React40.useCallback((externalHandlers) => (event) => {
    var _a;
  ...
  const createHandlePointerOver = React40.useCallback((externalHandlers) => (event) => {
    var _a;
...
var CompoundComponentContext = React41.createContext(null);
if (true) {
...
function useCompoundParent() {
  const [subitems, setSubitems] = React41.useState(/* @__PURE__ */ new Map());
  const subitemKeys = React41.useRef(/* @__PURE__ */ new Set());
  const deregisterItem = React41.useCallback(function deregisterItem2(id) {
  ...
  const registerItem = React41.useCallback(function registerItem2(id, item) {
  ...
  const sortedSubitems = React41.useMemo(() => sortSubitems(subitems), [subitems]);
  const getItemIndex = React41.useCallback(function getItemIndex2(id) {
...
function useMenu(parameters = {}) {
  ...
  const {
    ...
    triggerElement,
    registerPopup
  } = React43.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT;
...
var Portal = React46.forwardRef(function Portal2(props, forwardedRef) {
  ...
  const handleRef = useForkRef(React46.isValidElement(children) ? getReactElementRef(children) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React46.isValidElement(children)) {
      ...
      return React46.cloneElement(children, newProps);
    }
    return children;
  }
...
var MenuButton = React54.forwardRef(function MenuButton2(props, forwardedRef) {
  const {
    children,
    disabled = false,
    label,
...
function useMenuItem(params) {
  ...
  const {
    dispatch
  } = React55.useContext(DropdownContext) ?? FALLBACK_MENU_CONTEXT2;
  const {
    getRootProps: getListRootProps,
    highlighted
  } = useListItem({
...
function useMenuItemContextStabilizer(id) {
  ...
  const localGetItemState = React56.useCallback((itemValue) => {
    if (itemValue !== itemId) {
  ...
  const localContextValue = React56.useMemo(() => ({
    dispatch,
...
function useModal(parameters) {
  ...
  const modal = React58.useRef({});
  const mountNodeRef = React58.useRef(null);
  const modalRef = React58.useRef(null);
  const handleRef = useForkRef(modalRef, rootRef);
  const [exited, setExited] = React58.useState(!open);
  ...
  const isTopModal = React58.useCallback(() => manager.isTopModal(getModal()), [manager]);
...
var InnerOption = React66.forwardRef(function InnerOption2(props, forwardedRef) {
  var _a, _b;
  const {
    children,
    disabled = false,
...
var InnerOptionMemo = React66.memo(InnerOption);
var Option = React66.forwardRef(function Option2(props, ref) {
  const {
    value
  } = props;
  const {
...
function defaultRenderValue(selectedOptions) {
  if (Array.isArray(selectedOptions)) {
    return (0, import_jsx_runtime25.jsx)(React70.Fragment, {
...
var Select = React70.forwardRef(function Select2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime25.jsxs)(React70.Fragment, {
...
var Slider = React72.forwardRef(function Slider2(props, forwardedRef) {
  ...
  return (0, import_jsx_runtime26.jsxs)(Root, {
    ...
    children: [(0, import_jsx_runtime26.jsx)(Rail, {
      ...
      return (0, import_jsx_runtime26.jsxs)(React72.Fragment, {
...
var TextareaAutosize = React90.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  ...
  const heightRef = React90.useRef(null);
  const shadowRef = React90.useRef(null);
  const calculateTextareaStyles = React90.useCallback(() => {
  ...
  return (0, import_jsx_runtime37.jsxs)(React90.Fragment, {
...
var LoadingButton = React94.forwardRef(function LoadingButton2(inProps, ref) {
...
var LocalizationProvider = React95.forwardRef(function DeprecatedLocalizationProvider() {
  warn15();
  return null;
});
...
var MobileDatePicker = React96.forwardRef(function DeprecatedMobileDatePicker(props, ref) {
  warn16();
  return null;
});
...
var MobileDateRangePicker = React97.forwardRef(function DeprecatedMobileDateRangePicker() {
  warn17();
  return null;
});
...
var MobileDateTimePicker = React98.forwardRef(function DeprecatedMobileDateTimePicker() {
  warn18();
  return null;
});
...
var MobileTimePicker = React99.forwardRef(function DeprecatedMobileTimePicker() {
  warn19();
  return null;
});
...
var MonthPicker = React100.forwardRef(function DeprecatedMonthPicker() {
  warn20();
  return null;
});
...
var Pagination_default2 = React101.forwardRef(function DeprecatedPagination(props, ref) {
  warn21();
...
var PaginationItem_default2 = React102.forwardRef(function DeprecatedPaginationItem(props, ref) {
  warn22();
...
var CalendarPickerSkeleton = React103.forwardRef(function DeprecatedCalendarPickerSkeleton() {
  warn23();
  return null;
});
...
var PickersDay = React104.forwardRef(function DeprecatedPickersDay() {
  warn24();
  return null;
});
...
var StaticDatePicker = React110.forwardRef(function DeprecatedStaticDatePicker() {
  warn30();
  return null;
});
...
var StaticDateRangePicker = React111.forwardRef(function DeprecatedStaticDateRangePicker() {
  warn31();
  return null;
});
...
var StaticDateTimePicker = React112.forwardRef(function DeprecatedStaticDateTimePicker() {
  warn32();
  return null;
});
...
var StaticTimePicker = React113.forwardRef(function DeprecatedStaticTimePicker() {
  warn33();
  return null;
});
...
var Context = React114.createContext(null);
if (true) {
  Context.displayName = "TabContext";
}
function useUniquePrefix() {
  const [id, setId] = React114.useState(null);
  React114.useEffect(() => {
...
function useTabContext() {
  return React114.useContext(Context);
}
...
var TabList = React115.forwardRef(function TabList2(props, ref) {
  const {
...
var TabPanel3 = React116.forwardRef(function TabPanel4(inProps, ref) {
...
var TimePicker = React117.forwardRef(function DeprecatedTimePicker() {
  warn34();
  return null;
});
...
var TimelineContext = React118.createContext({});
if (true) {
...
var Timeline = React119.forwardRef(function Timeline2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimeline"
  });
...
var TimelineConnector = React120.forwardRef(function TimelineConnector2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineConnector"
  });
...
var TimelineContent = React121.forwardRef(function TimelineContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineContent"
  });
...
var TimelineDot = React122.forwardRef(function TimelineDot2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineDot"
  });
...
var TimelineOppositeContent = React123.forwardRef(function TimelineOppositeContent2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineOppositeContent"
  });
...
var TimelineItem = React124.forwardRef(function TimelineItem2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineItem"
  });
  ...
  React124.Children.forEach(props.children, (child) => {
...
var TimelineSeparator = React125.forwardRef(function TimelineSeparator2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiTimelineSeparator"
  });
...
var ToggleButton_default2 = React126.forwardRef(function DeprecatedToggleButton(props, ref) {
  warn35();
...
var ToggleButtonGroup_default2 = React127.forwardRef(function DeprecatedToggleButtonGroup(props, ref) {
  warn36();
...
var TreeItem = React128.forwardRef(function DeprecatedTreeItem() {
  warn37();
  return null;
});
...
var TreeView = React129.forwardRef(function DeprecatedTreeView() {
  warn38();
  return null;
});
...
var Masonry = React130.forwardRef(function Masonry2(inProps, ref) {
  const props = useThemeProps({
    props: inProps,
    name: "MuiMasonry"
  });
  ...
  const masonryRef = React130.useRef();
  const [maxColumnHeight, setMaxColumnHeight] = React130.useState();
  const isSSR = !maxColumnHeight && defaultHeight && defaultColumns !== void 0 && defaultSpacing !== void 0;
  const [numberOfLineBreaks, setNumberOfLineBreaks] = React130.useState(isSSR ? defaultColumns - 1 : 0);
  const ownerState = {
    ...props,
    spacing,
    columns,
  ...
  const handleResize = React130.useCallback((masonryChildren) => {
...
var DialogsContext = React131.createContext(null);
...
function DialogsProvider(props) {
  ...
  const [stack, setStack] = React133.useState([]);
  const keyPrefix = React133.useId();
  const nextId2 = React133.useRef(0);
  const requestDialog = React133.useCallback(function open(Component, payload, options = {}) {
    const {
      onClose = async () => {
      }
    } = options;
  ...
  const closeDialogUi = React133.useCallback(function closeDialogUi2(dialog) {
  ...
  const closeDialog = React133.useCallback(async function closeDialog2(dialog, result) {
...
function useStorageState(area, key, initializer = null, options) {
  ...
  const [initialValue] = React134.useState(initializer);
  const encodedInitialValue = React134.useMemo(() => encode(codec, initialValue), [codec, initialValue]);
  const subscribeKey = React134.useCallback((callback) => subscribe(area, key, callback), [area, key]);
  const getKeySnapshot = React134.useCallback(() => getSnapshot(area, key) ?? encodedInitialValue, [area, encodedInitialValue, key]);
  const encodedStoredValue = React134.useSyncExternalStore(subscribeKey, getKeySnapshot, getKeyServerSnapshot);
  const storedValue = React134.useMemo(() => decode(codec, encodedStoredValue), [codec, encodedStoredValue]);
  const setStoredValue = React134.useCallback((value) => {
  ...
  const [nonStoredValue, setNonStoredValue] = React134.useState(initialValue);
  if (!key) {
...
function LegacyThemeProvider(props) {
  ...
  const dualAwareTheme = React135.useMemo(() => isDualTheme ? theme[paletteMode === "dark" ? "dark" : "light"] ?? theme[paletteMode === "dark" ? "light" : "dark"] : theme, [isDualTheme, paletteMode, theme]);
  const paletteModeContextValue = React135.useMemo(() => ({
    paletteMode,
...
var AuthenticationContext = React136.createContext(null);
var SessionContext = React136.createContext(null);
...
@mui/lab/index.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-A5HR56B2.js.map
